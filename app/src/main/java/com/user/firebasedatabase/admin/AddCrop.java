...
public class AddCrop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("cropname") != null) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (submit.getText().toString().equalsIgnoreCase("Update")) {
                    ...
                    AddCropPojo cropPojo = new AddCropPojo(cropname.getText().toString(), marketprice.getText().toString(), scheduleprice.getText().toString(), image, Common.mobileno);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference.child("uploads/" + taskSnapshot.getMetadata().getName()).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    AddCropPojo cropPojo = new AddCropPojo(cropname.getText().toString(), marketprice.getText().toString(), scheduleprice.getText().toString(), uri.toString(),Common.mobileno);
