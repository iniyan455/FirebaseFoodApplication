                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    myRef.child(auth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            Common.address = value.getAddress();
                                            Common.Type = value.getTypeofuser();
                                            Common.uuid = auth.getCurrentUser().getUid();


                                            SharedPreferences.Editor editor = sharedpreferences.edit();
                                            editor.putString(Common.u_name, value.getEmail());
                                            editor.putString(Common.password, value.getPassword());
                                            editor.putString(Common.getType, value.getTypeofuser());
                                            editor.putString(Common.mobile, value.getMobileno());
                                            editor.apply();
