...
public class ProducerViewDetails extends RecyclerView.ViewHolder {
    ...
    public TextView marketprice,deliveryoption ,cropname, scheduleprice, quantity,address, total;
    ImageView imageView;
    Button cardview,selfbuy;
    ...
    ProducerViewDetails(View itemView) {
        ...
        selfbuy= (Button) itemView.findViewById(R.id.selfbuy);
