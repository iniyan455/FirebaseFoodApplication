...
public class Signup extends AppCompatActivity {
    private EditText inputEmail, inputMobileno, inputPassword, inputName, address;
    ...
    private void writeNewUser(String userId, String mobileno, String email, String name) {
        ...
        User user = new User(mobileno, email, "User", address.getText().toString(), name,inputPassword.getText().toString());
